...
class BlinkIDWrapper {
      convertNativeResultToJSResult(nativeResults, recognizerCollection) {
            let results = [];
      ...
      async scanMultipleWithCamera(overlaySettings, recognizerCollection, license) {
            try {
                  var licenseObject = license;
                  if (typeof license === 'string' || license instanceof String) {
                        licenseObject = { licenseKey: license };
                  }
                  const nativeResults = await BlinkIDNative.scanMultipleWithCamera(overlaySettings, recognizerCollection, licenseObject);
                  return this.convertNativeResultToJSResult(nativeResults, recognizerCollection)
            } catch (error) {
                  console.log(error);
                  return [];
            }
...
export * from './recognizers/austriaDlFrontRecognizer'
...
export * from './recognizers/blinkCardEliteRecognizer'
...
export * from './recognizers/bruneiMilitaryIdBackRecognizer'
export * from './recognizers/bruneiMilitaryIdFrontRecognizer'
export * from './recognizers/bruneiResidencePermitBackRecognizer'
export * from './recognizers/bruneiResidencePermitFrontRecognizer'
export * from './recognizers/bruneiTemporaryResidencePermitBackRecognizer'
export * from './recognizers/bruneiTemporaryResidencePermitFrontRecognizer'
